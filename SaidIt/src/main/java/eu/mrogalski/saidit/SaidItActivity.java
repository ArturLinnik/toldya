...
public class SaidItActivity extends AppCompatActivity {
    ...
    private androidx.appcompat.app.AlertDialog permissionDeniedDialog;
    private androidx.appcompat.app.AlertDialog storagePermissionDialog;
        ...
        if (requestCode == PERMISSION_REQUEST_CODE) {
            ...
            if (allPermissionsGranted) {
                if (Environment.isExternalStorageManager()) {
                    ...
                    storagePermissionDialog = new MaterialAlertDialogBuilder(this)
    ...
    private void showPermissionDeniedDialog() {
        permissionDeniedDialog = new MaterialAlertDialogBuilder(this)
                .setTitle(R.string.permission_required)
                .setMessage(R.string.permission_required_message)
                .setPositiveButton(R.string.allow, new DialogInterface.OnClickListener() {
                    @Override
